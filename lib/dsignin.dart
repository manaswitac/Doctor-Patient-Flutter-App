      ...
      if (snapshot.exists) {
        if (snapshot.value['role'] == 'doctor') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (context) => DoctorsHome(snapshot.value['email'],snapshot.value['name'],int.parse(snapshot.value['phone'].toString()),snapshot.value['age'])),
          );
        }
...
class DoctorDrawer extends StatelessWidget{
  ...
  DoctorDrawer({required this.uid,required this.name,required this.rollno,required this.age});
  final String uid;
  final String name;
  final int rollno;
  final String age;
...
class DoctorsHome extends StatelessWidget {
  ...
  DoctorsHome(this.uid,this.name,this.rollno,this.age);
  final String uid;
  final String name;
  final int rollno;
  final String age;
  ...
  // }
    ...
    drawer: DoctorDrawer(uid:uid,name:name,rollno:rollno,age:age),);
    }
}
